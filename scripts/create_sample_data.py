...
def build_sample_workbook(output_path: str = "sample_pwa_input.xlsx") -> None:
    ...
    site_a = pd.DataFrame({
        "Company": ["HD", "H.D.", "HD LLC", "HD", "HN", "HN", "HN"],
        "Name": ["A1", "A2", "A3", "A4", "John Smith", "Jon Smith", "Coordinator1"],
        "Task": ["Firmware update", "F/W Update", "Firm ware update", "Inspection", "Inspection", "Inspecton", "Commissioning"],
        "SOP": ["SOP-001", "SOP001", "S0P-001", "SOP-002", "SOP-003", "SOP-003", ""],
        "2026-05-04": [8, 0, 0, 0, 4, 0, 8],
        "2026-05-05": [0, 8, 8, 8, 4, 4, 8],
        "2026-06-01": [0, 0, 0, 4, 0, 0, 0],
    })
...
def build_master_workbook(output_path: str = "sample_master.xlsx") -> None:
    ...
    worker = pd.DataFrame({"Worker": ["A1", "A2", "A3", "A4", "B1", "B2", "B3", "John Smith", "Coordinator1"]})
    work = pd.DataFrame({"Task": ["Firmware update", "F/W Update", "Firm ware update", "Commissioning", "Inspection", "Water pump replacement"]})
